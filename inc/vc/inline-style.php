...
class Earth_Inline_Style {
	...
	private function parse_width( $value ) {
		$this->style[] = 'width:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_border_top_width( $value ) {
		$this->style[] = 'border-top-width:'. earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_border_bottom_width( $value ) {
		$this->style[] = 'border-bottom-width:'. earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_margin_right( $value ) {
		$this->style[] = 'margin-right:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_margin_left( $value ) {
		$this->style[] = 'margin-left:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_margin_top( $value ) {
		$this->style[] = 'margin-top:'. earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_margin_bottom( $value ) {
		$this->style[] = 'margin-bottom:'. earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_padding_top( $value ) {
		$this->style[] = 'padding-top:'. earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_padding_bottom( $value ) {
		$this->style[] = 'padding-bottom:'.  earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_padding_left( $value ) {
		$this->style[] = 'padding-left:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_padding_right( $value ) {
		$this->style[] = 'padding-right:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_font_size( $value ) {
		$this->style[] = 'font-size:'. earth_sanitize_data( $value, 'font_size' ) .';';
	}
	...
	private function parse_font_weight( $value ) {
		$this->style[] = 'font-weight:'. earth_sanitize_data( $value, 'font_weight' ) .';';
	}
	...
	private function parse_opacity( $value ) {
		if ( $opacity = earth_sanitize_data( $value, 'opacity' ) ) {
	...
	private function parse_letter_spacing( $value ) {
		$this->style[] = 'letter-spacing:'. earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_line_height_px( $value ) {
		$this->style[] = 'line-height:'. earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_height( $value ) {
		$this->style[] = 'height:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_height_px( $value ) {
		$this->style[] = 'height:'. earth_sanitize_data( $value, 'px' ) .';';
	}
	...
	private function parse_min_height( $value ) {
		$this->style[] = 'min-height:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_border_radius( $value ) {
		$this->style[] = 'border-radius:'. earth_sanitize_data( $value, 'border_radius' ) .';';
	}
	...
	private function parse_top( $value ) {
		$this->style[] = 'top:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_bottom( $value ) {
		$this->style[] = 'bottom:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_right( $value ) {
		$this->style[] = 'right:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
	...
	private function parse_left( $value ) {
		$this->style[] = 'left:'. earth_sanitize_data( $value, 'px-pct' ) .';';
	}
...
// Helper function runs the Earth_Inline_Style class
function earth_inline_style( $atts = array(), $add_style = true ) {
	if ( ! empty( $atts ) && is_array( $atts ) ) {
		$inline_style = new Earth_Inline_Style( $atts, $add_style );
