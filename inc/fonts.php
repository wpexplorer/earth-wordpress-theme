<?php
/**
 * Font family arrays - used in custom VC modules
 *
...
function earth_standard_fonts() {
	return apply_filters( 'earth_standard_fonts_array', array(
...
function earth_enqueue_google_font( $font) {
	...
	// Subset
	$subset = apply_filters( 'earth_fonts_subset', 'latin' );
	$subset = '&amp;subset='. $subset;

	// Weights
	$weights = array( '100', '200', '300', '400', '500', '600', '700', '800', '900' );
	$weights = apply_filters( 'earth_google_font_enqueue_weights', $weights, $font );
	$italics = apply_filters( 'earth_google_font_enqueue_italics', true );

	// Main URL
	$url = esc_url( apply_filters( 'earth_get_google_fonts_url', '//fonts.googleapis.com' ) );
	$url = $url .'/css?family='. str_replace(' ', '%20', $font ) .':';
	...
	// Enqueue style
	wp_enqueue_style( 'earth-google-font-'. $handle, $url, false, false, 'all' );
